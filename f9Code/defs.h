...
#define	LEXLBK		14	/* Left bracket					*/
#define	LEXRBK		15	/* Right bracket				*/
#define	LEXSEMI		16	/* Semicolon					*/
#define	LEXCOMMA	17	/* Comma					*/
#define	LEXADDOP	18	/* Addition operator ( + or - )			*/
#define	LEXMULOP	19	/* Multiplication operator ( * or / )		*/
#define	LEXCMPOP	20	/* Comparison operator ( < >  <= >= == != )	*/
#define	LEXLOGIC	21	/* Logical connector ( &&  or  || )		*/
#define	LEXASNOP	22	/* Assignment operator ( = += -= *= /=    )	*/
#define	LEXSTR		23	/* Quoted string				*/
#define	LEXFCN		24	/* Function call				*/
...
extern	void	parseaddn(void);
extern	void	parsemuln(void);
